      ...
      <main className="min-h-screen bg-[#f3f3f3]">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
            {[
              { icon: Package, label: 'Your Orders', sub: `${orders?.length ?? 0} orders`, href: '#orders' },
              { icon: Heart, label: 'Your Wishlist', sub: `${wishlistItems?.length ?? 0} items`, href: '#wishlist' },
              { icon: User, label: 'Account Details', sub: user.email || 'Manage profile', href: '#profile' },
          ...
          <section id="orders" className="mb-10">
            ...
            {orders === undefined ? (
              ...
              <div className="bg-white border border-[#ddd] rounded p-8 text-center">
                ...
                <p className="text-sm text-[#565959] mb-4">When you place an order, it will appear here.</p>
                    ...
                    <div className="bg-[#f0f2f2] border-b border-[#ddd] px-5 py-3 flex flex-wrap gap-4 justify-between items-center">
                      <div className="flex flex-wrap gap-6 text-xs text-[#565959]">
                        ...
                        <div>
                          ...
                          <p>
                            <span className={`inline-block px-2 py-0.5 rounded text-xs font-semibold capitalize ${STATUS_COLORS[order.status] ?? ''}`}>
                              {order.status}
                            </span>
                          </p>
                        </div>
