      ...
      <main className="min-h-screen bg-[#f3f3f3]">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex gap-5">
            ...
            <aside
              className={`${
                isFilterOpen ? 'fixed inset-0 z-40 bg-white overflow-auto' : 'hidden'
              } lg:block lg:static lg:z-auto lg:bg-transparent w-full lg:w-56 flex-shrink-0`}
            >
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    <button
                      ...
                      className={`block w-full text-left text-sm px-0 py-0.5 ${
                        selectedCategory === null
                          ? 'font-bold text-[#c45500]'
                    ...
                    {categories.map(cat => (
                      <button
                        ...
                        className={`block w-full text-left text-sm px-0 py-0.5 capitalize ${
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="bg-[#eaf4fe] border border-[#bcd5eb] rounded px-4 py-2 flex items-center justify-between mb-4 flex-wrap gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-[#0f1111]">{filtered.length} results</span>
                </div>
                <div className="flex items-center gap-2">
