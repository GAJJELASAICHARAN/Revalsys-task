...
const importedProducts: ImportedProduct[] = [
  ...
  // Accessories (Amazon.in "accessories electronics" organic_results positions 1–20)
  {
    id: 81,
    name: 'Travel Organizer Charger Pouch for Electronic Accessories (B0GPY72Y55)',
    brand: 'Homzify',
    ...
    stock: 200,
    description:
      'Double-layer waterproof travel organizer pouch for electronics accessories like cables, cords, chargers, adapters and drives.',
    image: 'https://m.media-amazon.com/images/I/81dDa7+fZUL._AC_UY218_.jpg',
    features: ['Type: Organizer pouch', 'Layers: Double', 'Waterproof: Yes', 'Use: Cables/chargers/adapters', 'ASIN: B0GPY72Y55'],
  },
  {
    id: 82,
    name: 'EUCOS 62" Phone Tripod + Selfie Stick with Remote (B0FM8C47F6)',
    brand: 'EUCOS',
    category: 'Accessories',
    price: 2999,
    discountPrice: 2088,
    ...
    reviewsCount: 20100,
    description:
      'Extendable phone tripod and selfie stick combo with remote, compatible with iPhone/Android for stable photos and videos.',
    image: 'https://m.media-amazon.com/images/I/61LnPbT7KML._AC_UY218_.jpg',
    features: ['Accessory: Phone tripod', 'Max height: 62"', 'Remote: Included', 'Compatibility: iPhone/Android', 'ASIN: B0FM8C47F6'],
  },
  {
    id: 83,
    name: 'Sounce 5-in-1 Multi-Function Laptop/Keyboard Cleaning Kit (B0BQDSZWFR)',
    brand: 'Sounce',
    category: 'Accessories',
    price: 999,
    discountPrice: 99,
    ...
    badge: 'Deal',
    description:
      '5-in-1 gadget cleaning kit with brush and tools for laptops, keyboards and earphones; includes key-cap puller and gap duster.',
    image: 'https://m.media-amazon.com/images/I/61ePjhX6O8L._AC_UY218_.jpg',
    features: ['Accessory: Cleaning kit', 'Functions: 5-in-1', 'Includes: Brush/gap duster/key-cap puller', 'Use: Laptop/keyboard/earphones', 'ASIN: B0BQDSZWFR'],
  },
  {
    id: 84,
    name: 'WALLVIEW TECH Mobile Phone Charging Stand & Storage Holder (B0FLPH3MBW)',
    brand: 'WALLVIEW TECH',
    category: 'Accessories',
    price: 999,
    discountPrice: 169,
    ...
    reviewsCount: 378,
    description:
      'Multi-functional bedside phone charging stand and organizer for bedroom/office; keeps phone and small accessories in one place.',
    image: 'https://m.media-amazon.com/images/I/71apLn1qsgL._AC_UY218_.jpg',
    features: ['Accessory: Charging stand', 'Use: Bedside/office', 'Color: White', 'Storage: Multi-functional holder', 'ASIN: B0FLPH3MBW'],
  },
  {
    id: 85,
    name: 'GLUN Digital LED Luggage Weighing Scale 50kg/110lb (B07PK41FL4)',
    brand: 'GLUN',
    category: 'Accessories',
    price: 899,
    discountPrice: 248,
    ...
    reviewsCount: 28600,
    description:
      'Portable digital luggage weighing scale with LED screen, supports up to 50kg/110lb for travel and household weighing.',
    image: 'https://m.media-amazon.com/images/I/61Z35SZs7lL._AC_UY218_.jpg',
    features: ['Accessory: Weighing scale', 'Max: 50kg/110lb', 'Display: LED', 'Portable: Yes', 'ASIN: B07PK41FL4'],
  },
  {
    id: 86,
    name: 'Portronics MODESK Universal Mobile Holder Stand (B07N8RQ6W7)',
    brand: 'Portronics',
    category: 'Accessories',
    price: 699,
    discountPrice: 99,
    ...
    reviewsCount: 30600,
    description:
      'Universal metal mobile holder stand with anti-skid design; works with smartphones, tablets, Kindle and iPad.',
    image: 'https://m.media-amazon.com/images/I/51u2MqPaQwL._AC_UY218_.jpg',
    features: ['Accessory: Mobile stand', 'Build: Metal', 'Design: Anti-skid', 'Compatibility: Phones/tablets/Kindle/iPad', 'ASIN: B07N8RQ6W7'],
  },
  {
    id: 87,
    name: 'rts USB Universal International Travel Adapter (B082WYMTWF)',
    brand: 'rts',
    category: 'Accessories',
    price: 4999,
    discountPrice: 499,
    ...
    badge: 'Deal',
    description:
      'All-in-one worldwide travel adapter and wall charger with multiple outlet types and USB 2.1A output; supports 100–250V.',
    image: 'https://m.media-amazon.com/images/I/611RCy1XjsL._AC_UY218_.jpg',
    features: ['Accessory: Travel adapter', 'Voltage: 100–250V', 'USB: 2.1A', 'Worldwide: Multi-type outlet', 'ASIN: B082WYMTWF'],
  },
  {
    id: 88,
    name: 'SaleOn Cable Organizer Case Bag (B0DLBRVQCC)',
    brand: 'SaleOn',
    category: 'Accessories',
    price: 899,
    discountPrice: 298,
    ...
    reviewsCount: 352,
    description:
      'Water-resistant portable storage organizer bag for electronics accessories, cables and hard drives; sleek black design.',
    image: 'https://m.media-amazon.com/images/I/81GaofCt8VL._AC_UY218_.jpg',
    features: ['Type: Organizer case', 'Water-resistant: Yes', 'Use: Cables/hard drive', 'Color: Black', 'ASIN: B0DLBRVQCC'],
  },
  {
    id: 89,
    name: 'Tensea ABS Mobile Phone Charging Stand & Storage Holder (B0CX5GY71W)',
    brand: 'Tensea',
    category: 'Accessories',
    price: 324,
    discountPrice: 84,
    ...
    reviewsCount: 5700,
    description:
      'Compact ABS bedside charging stand and storage holder for portable devices; keeps essentials organized on desk or bedside.',
    image: 'https://m.media-amazon.com/images/I/61jVUB4y7pL._AC_UY218_.jpg',
    features: ['Accessory: Charging stand', 'Material: ABS', 'Use: Bedside/office', 'Size: 9.9 x 3 x 8.6 cm', 'ASIN: B0CX5GY71W'],
  },
  {
    id: 90,
    name: 'Portronics Bridge Y USB 3.0 to Type-C OTG Adapter 10Gbps (B0DH3J6LB9)',
    brand: 'Portronics',
    category: 'Accessories',
    price: 599,
    discountPrice: 119,
    ...
    reviewsCount: 5700,
    description:
      'USB 3.0 to Type-C OTG adaptor supporting up to 10Gbps data transfer; compatible with Type-C smartphones, laptops and tablets.',
    image: 'https://m.media-amazon.com/images/I/616jdfyhw8L._AC_UY218_.jpg',
    features: ['Accessory: OTG adapter', 'USB: 3.0', 'To: Type-C', 'Speed: up to 10Gbps', 'ASIN: B0DH3J6LB9'],
  },
  {
    id: 91,
    name: 'DailyObjects Vault Tech Electronic Accessories Bag (B0CRF46WKB)',
    brand: 'DailyObjects',
    category: 'Accessories',
    price: 3229,
    discountPrice: 2299,
    ...
    reviewsCount: 234,
    description:
      'Portable tech organizer bag with multiple slip pockets and zipper closure for cables, chargers, adapters, drives and power banks.',
    image: 'https://m.media-amazon.com/images/I/81QOyIhp4eL._AC_UY218_.jpg',
    features: ['Type: Tech organizer bag', 'Closure: Zipper', 'Pockets: Multiple', 'Use: Cables/chargers/power bank', 'ASIN: B0CRF46WKB'],
  },
  {
    id: 92,
    name: 'POLAM-FOTO 74"/188cm Professional Aluminum Tripod (B0F6BV211J)',
    brand: 'POLAM-FOTO',
    category: 'Accessories',
    price: 5999,
    discountPrice: 2851,
    ...
    reviewsCount: 353,
    description:
      'Heavy-duty camera tripod with 360-degree head, phone holder mount and carry bag; supports cameras, phones and GoPro.',
    image: 'https://m.media-amazon.com/images/I/71DGyBWrz+L._AC_UY218_.jpg',
    features: ['Accessory: Tripod', 'Max height: 74"/188cm', 'Head: 360-degree', 'Includes: Phone mount + carry bag', 'ASIN: B0F6BV211J'],
  },
  {
    id: 93,
    name: 'Portronics Snapcase 2 60W Multifunction Data Cable Kit (B0DPX6M4L5)',
    brand: 'Portronics',
    category: 'Accessories',
    price: 999,
    discountPrice: 449,
    ...
    reviewsCount: 620,
    description:
      'Pocket-size retractable 60W charging/data cable kit with conversion set (USB-A/Type-C to Micro/Lightning) plus SIM storage and eject pin.',
    image: 'https://m.media-amazon.com/images/I/61U53pEqNwL._AC_UY218_.jpg',
    features: ['Accessory: Cable kit', 'Power: 60W', 'Cable: Retractable', 'Adapters: Micro + Lightning', 'Extras: SIM storage + eject pin', 'ASIN: B0DPX6M4L5'],
  },
  {
    id: 94,
    name: 'Portronics Snapcase 3 60W Multifunction Data Cable Kit (B0DTPGC83R)',
    brand: 'Portronics',
    category: 'Accessories',
    price: 799,
    discountPrice: 299,
    ...
    reviewsCount: 1200,
    description:
      'Pocket-size 60W charging/data cable kit with conversion set (USB-A/Type-C to Micro/Type-C/Lightning) plus SIM storage and eject pin.',
    image: 'https://m.media-amazon.com/images/I/61t1Q0eNs7L._AC_UY218_.jpg',
    features: ['Accessory: Cable kit', 'Power: 60W', 'Adapters: Micro/Type-C/Lightning', 'Extras: SIM storage + eject pin', 'Color: Blue', 'ASIN: B0DTPGC83R'],
  },
  {
    id: 95,
    name: 'Ambrane 20-in-1 Cleaning Kit for Devices (ACK-01) (B0CQM2L6DQ)',
    brand: 'Ambrane',
    category: 'Accessories',
    price: 1299,
    discountPrice: 549,
    ...
    reviewsCount: 534,
    description:
      '20-in-1 cleaning kit for smartphones, tablets, PCs, laptops, keyboards, cameras and earbuds; includes brush, key puller and spray bottle.',
    image: 'https://m.media-amazon.com/images/I/71QgVgwtWcL._AC_UY218_.jpg',
    features: ['Accessory: Cleaning kit', 'Tools: 20-in-1', 'Includes: Brush/key puller/spray bottle', 'Use: Phone/tablet/laptop/earbuds', 'ASIN: B0CQM2L6DQ'],
  },
  {
    id: 96,
    name: 'IRONFIX TechMate Gadget Organizer Case (B0DNTQB4N1)',
    brand: 'IRONFIX',
    category: 'Accessories',
    price: 299,
    discountPrice: 149,
    ...
    reviewsCount: 518,
    description:
      'Portable waterproof hard pouch organizer for chargers, cables, power bank, earphones and hard drive; travel-friendly compact case.',
    image: 'https://m.media-amazon.com/images/I/71deym55o2L._AC_UY218_.jpg',
    features: ['Type: Hard organizer pouch', 'Waterproof: Yes', 'Use: Charger/cables/power bank', 'Travel: Yes', 'ASIN: B0DNTQB4N1'],
  },
  {
    id: 97,
    name: 'Careflection Electronics Accessories Organizer Bag (B0CC2956ND)',
    brand: 'Careflection',
    category: 'Accessories',
    price: 999,
    discountPrice: 299,
    ...
    reviewsCount: 85,
    description:
      'Universal carry travel gadget bag for cables, plugs and accessories; sized to fit charger, hard disk and small devices (dark blue).',
    image: 'https://m.media-amazon.com/images/I/814jkwhsbaL._AC_UY218_.jpg',
    features: ['Type: Organizer bag', 'Material: Polyester', 'Color: Dark Blue', 'Use: Cables/plugs/hard disk', 'ASIN: B0CC2956ND'],
  },
  {
    id: 98,
    name: 'THEMISTO 27-in-1 Precision Screwdriver Set Repair Kit (B07NY2WXPH)',
    brand: 'THEMISTO',
    category: 'Accessories',
    price: 652,
    discountPrice: 262,
    ...
    reviewsCount: 12300,
    description:
      'Precision screwdriver repair tool kit with multiple bits for mobile phones, laptops and electronics; compact multi-pocket set.',
    image: 'https://m.media-amazon.com/images/I/71lwyj4rjmL._AC_UY218_.jpg',
    features: ['Accessory: Repair tool kit', 'Bits: 27-in-1', 'Use: Mobiles/laptops/electronics', 'Portable: Yes', 'ASIN: B07NY2WXPH'],
  },
  {
    id: 99,
    name: 'Sounce 3-in-1 Screen Cleaning Kit 100ml + Microfiber + Brush (B0BSLRB8NJ)',
    brand: 'Sounce',
    category: 'Accessories',
    price: 299,
    discountPrice: 149,
    ...
    badge: 'Deal',
    description:
      '3-in-1 cleaning kit for screens (PC, laptop, monitor, mobile, TV) with 100ml solution, microfiber cloth and brush; helps reduce static.',
    image: 'https://m.media-amazon.com/images/I/71CFc-fYMBL._AC_UY218_.jpg',
    features: ['Accessory: Screen cleaning kit', 'Includes: 100ml + microfiber + brush', 'Use: PC/laptop/monitor/mobile/TV', 'Anti-static: Yes', 'ASIN: B0BSLRB8NJ'],
  },
  {
    id: 100,
    name: 'LIRAMARK Mobile Phone Charging Stand & Storage Holder (B0BQMJZZNM)',
    brand: 'LIRAMARK',
    category: 'Accessories',
    price: 299,
    discountPrice: 119,
    ...
    reviewsCount: 3700,
    description:
      'Wall-mounted bedside phone charging stand and storage holder for home organization; keeps phone and small items tidy (pack of 1).',
    image: 'https://m.media-amazon.com/images/I/61mJSikurML._AC_UY218_.jpg',
    features: ['Accessory: Charging stand', 'Mount: Wall-mounted', 'Use: Bedroom/office/bathroom', 'Pack: 1', 'ASIN: B0BQMJZZNM'],
  },
];
